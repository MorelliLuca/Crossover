...
\pm 7.5 )\:Hz $ e $ \nu_{MH}= (1139\pm 11 )\:Hz $), e della frequenza di risonanza del filtro passa banda ($ \nu_{Ris}=(714.7\pm43)\: Hz$), che è invece risultato compatibile con quello teorico ($ \nu_{Ris}=(682\pm12)\: Hz$).
...
Come è possibile osservare in Fig. 3 questo è proprio quanto si verifica sperimentalmente, ossia che la tensione misurata ai capi del Function Generator ($V_{Gen}$ nello schema della Fig.1) non è costante, ma varia con la frequenza generata, modificando così i valori delle frequenze di crossover.
...
Come è possibile osservare i dati ottenuti da questi fit evidenziano una maggiore aderenza dei punti sperimentali in questo range ridotto rispetto al modello teorico ipotizzato, evidenziando come una delle principali cause di errore, seppur non l'unica, sia da identificare negli effetti dovuti alla resistenza interna del function generator. \\

Inoltre i valori più in accordo con le misure dirette sono quelli delle componenti resistive. Questa osservazione ci suggerisce che ulteriori fonti di errore siano da identificare nella misura delle induttanze e delle capacità: abbiamo infatti osservato che nell'arco di una mattinata il loro valore è risultato soggetto a fluttuazioni e, per questo motivo, si è considerato un valore medio tra più misure delle induttanze come miglior stima.  
\section{Conclusioni} 
