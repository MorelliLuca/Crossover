...
*/
graph->SetTitle("Risposta in frequenza Midrange;Frequenza [Hz];Tensione [V]");
...
TF1 *fitFun = new TF1("fitFun","[0] / sqrt((x*2*pi*[2]/[1] - 1/(x*2*pi*[1]*[3]))^2 + pow(([1]+50)/[1],2) )");
