...
TGraphErrors *graph = new TGraphErrors("data.txt","%lg%lg%lg%lg","");
graph->SetMarkerStyle(7);
graph->SetMarkerColor(kBlue);
graph->SetTitle("Function genrator;Frequenza [Hz]; Tensione [V]");
...
*/
TF1 *fitFun = new TF1("fitFun","[0] - [1]*TMath::Gaus(x,[2],[3])");
