...
*/
graph->SetTitle("Risposta in frequenza della fase filtro passa banda;Frequenza [Hz];Fase [Deg]");
...
TF1 *fitFun = new TF1("fitFun","[0]*TMath::ATan((1-(2*pi+x)*(2*pi*x)*[2]*[3])/(2*pi*x*[1]*[3]))");
